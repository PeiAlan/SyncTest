...
public class BlockingQueueTest {
    ...
    public void addTest() {
        ...
        log.debug(blockingQueue.add(1) + "");
        log.debug(blockingQueue.add(2) + "");
        log.debug(blockingQueue.add(3) + "");
    }
    ...
    public void removeTest() {
        ...
        blockingQueue.add(1);
        blockingQueue.add(2);
        log.debug(blockingQueue.remove() + "");
        log.debug(blockingQueue.remove() + "");
        log.debug(blockingQueue.remove() + "");
    }
    ...
    public void offerTest(){
        ArrayBlockingQueue<Integer> blockingQueue = new ArrayBlockingQueue<Integer>(2);
        log.debug(blockingQueue.offer(1) + "");
        log.debug(blockingQueue.offer(2) + "");
        log.debug(blockingQueue.offer(3) + "");
    }
